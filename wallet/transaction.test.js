...
describe('Transaction', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('subtacts the amount from the orinial sender output amount', () => {
                expect(transaction.outputMap[senderWallet.publicKey])
                    .toEqual(originalSenderOutput - nextAmount);
            });
    
            it('maintains a total output that mathes the input amount', () => {
                expect(
    ...
    describe('rewardTransaction()', () => {
        ...
        it('creates one transction for the miner with the `MINING_REWARD`', () => {
